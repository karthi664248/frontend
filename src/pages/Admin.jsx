...
import {
    ...
    PiCloudArrowDownBold, PiDeviceMobileBold, PiCloudArrowUpBold, PiEyeBold, PiStarFill
} from "react-icons/pi";
                ...
                <header className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-6 md:mb-12">
                    ...
                    <div className="flex bg-bgColorSecondary p-1.5 rounded-2xl border border-secondaryTextColor/10 shadow-lg overflow-x-auto no-scrollbar max-w-full">
                        {[
                            ...
                            { id: "reviews", icon: <PiStarFill />, label: "Reviews" },
                        ].map(tab => (
                            <button
                                key={tab.id}
                            ...
                            <div className="bg-btnColor/10 p-8 rounded-3xl border border-secondaryTextColor/10 shadow-sm transition-all">
                                ...
                                <div className="space-y-4">
                                    {[
                                        ...
                                        { id: 'showCardPlayButton', label: 'Card Play Button', desc: 'Online streaming play button on thumbnail hover' },
                                        { id: 'showRatingsReviews', label: 'Ratings & Reviews', desc: 'Viewer star ratings and written reviews section' }
                                    ].map(item => (
