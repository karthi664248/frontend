...
export default function MoviesAndSeriesDetailsSections(props) {
  ...
  return (
    <div className="relative bg-btnColor/40 p-3 md:p-10 rounded-3xl ">
      {!props.isMovieDataLoading ? (
        <>
          <div className="grid lg:grid-cols-2 content-center items-center gap-5 ">
            <div
              onClick={() => {
                if (props.detailType === "movie" && settings.showCardPlayButton !== false && settings.showCardPlayButton !== "false") {
                  addToRecentlyWatched(props.movieData);
                  setIsWatchMoviePopupOpen(true);
                }
              }}
              className={`aspect-video w-full relative flex items-center shrink-0 bg-btnColor rounded-3xl transition-all duration-300 ease-in-out ${
                props.detailType === "movie" && settings.showCardPlayButton !== false && settings.showCardPlayButton !== "false"
                  ? "cursor-pointer hover:scale-105"
                  : ""
              }`}
            >
              {settings.showCardPlayButton !== false && settings.showCardPlayButton !== "false" && props.detailType === "movie" && settings.showPlayerButton !== false ? (
            ...
            <div className="p-5">
              ...
              <div className="flex gap-2 text-primaryTextColor flex-wrap mt-2">
                <div className="flex flex-wrap items-center gap-2">
                  ...
                  <button
                    ...
                    className={`flex items-center justify-center gap-1.5 h-8 px-3 rounded-full transition-all duration-300 border ml-1 text-xs font-bold ${inWatchlist
                  ...
                  <button
                    ...
                    className="flex items-center justify-center gap-1.5 h-8 px-3 rounded-full transition-all duration-300 border ml-1 text-xs font-bold bg-red-500/10 text-red-500 border-red-500/30 hover:bg-red-500 hover:text-white"
              ...
              {props.detailType === "movie" && (
                <div className="grid grid-cols-2 md:flex md:flex-wrap gap-3 text-primaryTextColor mt-5 w-full">
                  ...
                  {settings.showPlayerButton !== false && settings.showPlayerButton !== "false" && (
            ...
            >
              ...
              <div className="flex flex-col gap-5 text-center mt-2">
                ...
                <div className="flex flex-col gap-3 mt-2">
                  {settings.showCardPlayButton !== false && settings.showCardPlayButton !== "false" && (
                    <button
                      onClick={() => {
                        addToRecentlyWatched(props.movieData);
                  ...
                  {(() => {
                    const showPlayer = settings.showPlayerButton !== false && settings.showPlayerButton !== "false";
                    ...
                    if (hasExternalLinks) {
                      return (
                        <div className="grid grid-cols-2 gap-3 w-full">
                          ...
                          {/* Links Button */}
                          <div className={showPlayer ? "col-span-1 md:col-span-2" : "col-span-2"}>
                            <Popover placement="bottom" showArrow={true}>
                              <PopoverTrigger>
      ...
      <ReviewsSection movieData={props.movieData} mediaType={props.detailType} />

      <ReportIssueModal
        isOpen={isReportOpen}
        onClose={() => setIsReportOpen(false)}
        movieData={props.movieData}
        mediaType={props.detailType}
      />
    </div>
  );
}
