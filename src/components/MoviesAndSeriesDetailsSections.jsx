              ...
              <div className="flex gap-2 text-primaryTextColor flex-wrap mt-2">
                <div className="flex flex-wrap items-center gap-2">
                  ...
                  <button
                    ...
                    className="flex items-center justify-center w-8 h-8 rounded-full transition-all duration-300 border ml-1 bg-bgColorSecondary dark:bg-white/10 text-primaryTextColor/70 dark:text-white/70 hover:bg-red-500/10 hover:text-red-500 border-secondaryTextColor/20 dark:border-white/10"
                    title="Report an Issue"
                  >
                    <PiFlagBold className="text-sm" />
                  </button>
                </div>
              </div>
